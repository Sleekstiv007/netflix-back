...
const sendMailx = async (output, email, h, s) => {
  try {
    ...
    let info = await transporter.sendMail({
      from: '"Express Coin Way" <support@expresscoinway.com>', // sender address
...
const sendingMsg = (name, value, heading, email) => {
  ...
  if (value > 0) {
    ...
    \nThank you for choosing Express Coin Way . For complaints or inquires, do not hesitate to contact our 24/7 support team via email: support@expresscoinway.com \n
...
export const withdraw = async (req, res) => {
  ...
  if (checkEmail(email)) {
    ...
    if (user) {
      ...
      // sendMailx(msg, 'support@expresscoinway.com', 'Withdrawal Requested');
...
export const approveDeposit = async (req, res) => {
  ...
  try {
    ...
    let msg = `Your Deposit of ${deposit}USD has been approved.
      \nThank you for choosing Express Coin Way. For complaints or inquires, do not hesitate to contact our 24/7 support team via email: support@expresscoinway.org\n
